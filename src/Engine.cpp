...
void Engine::Start()
{
	...
	D3D12_SHADER_RESOURCE_VIEW_DESC previewSrvDesc{};
	...
	mTexturePsoDesc.SampleMask = 0xFFFFFFFF;
...
void Engine::Update()
{
	...
	if (bOpenTextureGenerator)
	{
		...
		//ImGui::Image((ImTextureID)mTexturePreviewSRVGPUHandle.ptr, ImVec2(256, 256));
